...
import 'package:flutter_github_app/widget/user_header.dart';
import 'package:flutter_github_app/widget/user_item.dart';
      ...
      return UserItem(
        ...
        onPressed: () {
          NavigatorUtils.goPerson(
            context,
            UserItemViewModel.fromMap(pullLoadWidgetControl.dataList[index]).userName,
          );
        },
      );
    } else {
